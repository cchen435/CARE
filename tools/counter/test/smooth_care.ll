...
define i32 @smooth(i32* %igrid, i32* %mtheta, i32* %itran, double* %phism, double* %phitmp, double* %phi, i32 %mpsi) #0 !dbg !8 {
entry:
  br label %for.cond
...
!6 = !{}
!7 = !{!8}
!8 = distinct !DISubprogram(name: "smooth", linkageName: "smooth", scope: !5, file: !5, type: !9, isLocal: false, isDefinition: true, flags: DIFlagPrototyped, isOptimized: false, variables: !6)
...
!16 = !DILocation(line: 2, column: 2, scope: !8)
!17 = !DILocation(line: 3, column: 3, scope: !8)
!18 = !DILocation(line: 4, column: 4, scope: !8)
