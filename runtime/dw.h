...
/**
 * care_dw_dealloc_str: free a string allocated by dwarf library
 */
extern void care_dw_dealloc_str(care_dwarf_t handler, void *);
 ...
 */
extern int care_dw_get_src_info(care_dwarf_t dwarf, Dwarf_Addr PC, char **ret_file, int *ret_line,
                                int *ret_column);
